...
```
As previously mentioned, there are actually 3 different methods that perform a select query. Each one acts slightly differently as outlined below.
### ->one()
This method performs a select query and makes the first row of the resultset the 
