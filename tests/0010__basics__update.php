...
function test_0010__basics__update()
{
	...
	$org1_before = $lucid->db->organizations(1);
	$org1_before['name'] = $org1_before['name'] . ' testing script';
	$org1_before->save();
	$org1_after = $lucid->db->organizations(1);
	...
	$org3_before = $lucid->db->organizations(3);
	$org3_before['name'] = $org3_before['name'] . ' testing script';
	$org3_before->save();
	$org3_after = $lucid->db->organizations(3);
	...
	$org2_after = $lucid->db->organizations(2);
